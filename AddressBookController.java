...
public class AddressBookController {
    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String rollno = contactDetailsPanel.getrollnoField().getText();
            String state = contactDetailsPanel.getStateField().getText();
            flag = validate();
            if(flag)
            {    
             Person person = new Person();
             person.setData(name,mobile,email,rollno,state);
   ...
   */
    ...
    private void openEdit(){
        ...
        dialog.getPanel().setRollno(detailPanel.getrollnoField().getText());
    ...
    public void loadPersons()       
    {
        ...
        nlp.getJList().addListSelectionListener(new ListSelectionListener()
         ...
         detailPanel.getrollnoField().setEditable(false);
